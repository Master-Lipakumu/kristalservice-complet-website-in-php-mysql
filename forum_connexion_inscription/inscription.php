...
<head>
    <meta charset="utf-8" />
    <title>FORUM KRISTAL SERVICE</title>
    <link rel="icon" type="image/png" href="images/logo.png" />
    
    <meta name="author" content="LIPAKUMU AKUMA"> 
...
<body>
 <h1>Inscription</h1>
            ...
            <div id="Cforum" style="text-align: center;">
                <form method="post" action="inscription.php">
                    <p>
                        ...
                        ?>
                        <br><br>
                        <button><a href="connexion.php" style="color:blue; background-color: #fff;">connectez-vous</a></button>
                    </p>
                </form> 
